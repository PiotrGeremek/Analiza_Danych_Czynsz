...
**Najniższe ceny** wystąpiły w Radomiu (średnia 1851), dodatkowo **jako jedyne analizowane miasto** wykazało _**ujemną**_ skośność (-0.0827) Oznacza to, że większość ofert jest droższa od średniej.
